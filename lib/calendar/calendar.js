...
var Calendar = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Calendar, [{
    ...
    key: "_highlightedArray",
    value: function _highlightedArray() {
      var highlightedArray = this.props.highlightedArray;
      if (!highlightedArray) return [{
        end: null,
        start: null
      }];
      var validDates = highlightedArray.every(function (res) {
    ...
    value: function _renderMonth() {
      var _this$props4 = this.props,
          ...
          showWeekOnly = _this$props4.showWeekOnly,
      ...
      var highlightedArray = this._highlightedArray();
    ...
    value: function _renderMonthHeader() {
      var _this$props5 = this.props,
          ...
          showOnlySelectedWeek = _this$props5.showOnlySelectedWeek,
