  ...
  _createClass(Week, [{
    ...
    value: function _dateHighlighted(date) {
      var _this$props3 = this.props,
          ...
          highlightedArray = _this$props3.highlightedArray;

      if (highlightedArray) {
        return highlightedArray.some(function (res) {
          return (0, _is_within_range["default"])((0, _start_of_day["default"])(date), (0, _start_of_day["default"])(res.start), (0, _start_of_day["default"])(res.end));
        });
      }
